...
function pollReplacement() {
    const pollList = ['26053',
                    '26054',
                    '26056',
                    '26057',
                    '26057']
    
    randomPoll = pollList[getRandomInt(0,5)]
    
    if (document.getElementById("quick-poll-content")) {
        document.getElementById("quick-poll-content").setAttribute("data-project-quick-poll-link", randomPoll); 
    }
    for (const h5 of document.querySelectorAll('h5')) {
        if (h5.textContent.includes('We use customer comments')){
            h5.innerHTML = "<iframe id='quickPoll' title='ehq-embed-quick-poll' frameborder='0' marginwidth='0' scrolling='auto' width='100%' height='450px' src='https://engagerenfrewshire.uk.engagementhq.com/embeds/projects/25422/quick-poll/" + randomPoll + "'></iframe>" + "<br>" + h5.innerHTML;
        }
    }
}
